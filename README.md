# KrashoutBets — Rainbet wager leaderboard

Live at **https://krashoutbets.com/**

A one-page static site showing a $250 monthly wager leaderboard for Rainbet
affiliate code **KROB**. Generated from the Forge Partners leaderboard
...
| --- | --- |
| Affiliate code | `KROB` |
| Referral link | https://rainbet.com?r=krob |
...
5. **Point the domain** at Netlify and wait for the TLS certificate. A new
   ...
   certificate is actually issued for `krashoutbets.com` before telling anyone the
   site is live.
...
`creators/krashoutbets.json` in the template repo. Edit that, re-run
`node new-creator.mjs krashoutbets`, and copy the regenerated files over. The cycle
