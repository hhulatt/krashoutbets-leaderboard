/* KrashoutBets — monthly Rainbet wager leaderboard.
   ...
   creators/krashoutbets.json, which is also what writes them into
...
(() => {
  ...
  async function runSearch() {
    ...
    if (!match) {
      setResult(`No wagers found for "${query}" this cycle. Make sure you signed up with code KROB and that the spelling matches exactly.`, 'miss');
      return;
    }
